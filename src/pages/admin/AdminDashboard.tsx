...
import { Key, Search, Image } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      <div className="mb-6 text-center">
        ...
        <p className="text-gray-700">
          Get started in just 3 simple steps – and instantly search your WordPress media library, with optional AI enhancements.
        </p>
      </div>
