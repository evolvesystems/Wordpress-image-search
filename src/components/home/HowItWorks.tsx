...
const HowItWorks = () => (
  <section className="container mx-auto px-4 py-24 text-center" id="how-it-works">
    <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-11 tracking-tight">⚙️ How It Works</h2>
    <ol className="flex flex-col md:flex-row gap-8 justify-center mb-8">
      {steps.map(step => (
        <li key={step.title} className="flex-1 min-w-[220px] bg-blue-50 shadow rounded-xl p-8 border border-blue-200">
